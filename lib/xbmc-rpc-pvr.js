(function() {
    var XBMCPVR = function(delegate) {
        this.delegate = delegate;
    };

    XBMCPVR.prototype.getChannelDetails = function(params) {
    ...
    XBMCPVR.prototype.getChannelGroupDetails = function(params) {
        if (typeof(params) == 'number') {
            params = {
    ...
    XBMCPVR.prototype.getChannelGroups = function(params) {
    ...
    XBMCPVR.prototype.getChannels = function(params) {
    ...
    XBMCPVR.prototype.getProperties = function(params) {
        if (typeof(params) == 'string') {
            params = {
                "properties": [params]
            };
    ...
    XBMCPVR.prototype.record = function(params) {
    ...
    XBMCPVR.prototype.scan = function() {
        return this.delegate.rpc('PVR.Scan').then(function(r) {
            return r.result;
        });
    };

    module.exports = XBMCPVR;
})();
