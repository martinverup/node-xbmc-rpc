(function() {
    ...
    XBMCPlayer.prototype.open = function(params) {
        params = params || {};
    ...
    XBMCPlayer.prototype.playPause = function(params) {
    ...
    XBMCPlayer.prototype.rotate = function(params) {
        if (typeof(params) == 'string') {
            params = {
                "value": params
            };
    ...
    XBMCPlayer.prototype.seek = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "playerid": params
            };
    ...
    XBMCPlayer.prototype.setAudioStream = function(params) {
    ...
    XBMCPlayer.prototype.setPartymode = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "playerid": params
            };
    ...
    XBMCPlayer.prototype.setRepeat = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "playerid": params
            };
    ...
    XBMCPlayer.prototype.setShuffle = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "playerid": params
            };
    ...
    XBMCPlayer.prototype.setSpeed = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "playerid": params
            };
    ...
    XBMCPlayer.prototype.setSubtitle = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "playerid": params
            };
    ...
    XBMCPlayer.prototype.stop = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "playerid": params
            };
    ...
    XBMCPlayer.prototype.zoom = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "playerid": params
            };
    ...
    XBMCPlayer.prototype.SetVideoSpeed = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "speed": params
            };
    ...
    XBMCPlayer.prototype.getCurrentlyPlayingAudio = function() {
        var params = {};
        params.playerid = 0;
    ...
    XBMCPlayer.prototype.playPauseAudio = function() {
        var params = {};
        params.playerid = 0;
        return this.delegate.rpc('Player.PlayPause', JSON.stringify(params)).then(function(r) {
            return r.result;
    ...
    XBMCPlayer.prototype.SetAudioSpeed = function(params) {
        if (typeof(params) == 'number') {
            params = {
                "speed": params
            };
